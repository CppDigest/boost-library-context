# #156 - Modular Boost C++ Libraries Request [Closed]

> Username: grafikrobot  
> Created at: 2024-03-09 19:32:06 UTC  
> Updated at: 2024-03-11 12:47:15 UTC  
> Closed at: 2024-03-11 12:47:15 UTC  
> Url: https://github.com/boostorg/mpi/issues/156  
...
> Username: aminiussi  
> Created at: 2024-03-11 12:47:15 UTC  
> Url: https://github.com/boostorg/mpi/issues/156#issuecomment-1988362918  

Pull request, reviewed and merged by a BOOSTORG OWNER.  
  
I do not have b2 expertise worth mentioning, so I'm not sure are the most important points to consider, but:  
  
- boost.mpi depends on boost.serialize and, to lesser level, boost graph.  
- the testing framework requires launching multi process test. This is achieved through the mpi-test b2 function that was written before my time.  
- there is a python interface to Boost.mpi, implemented through Boost.python, so that's one more dependency to consider. Also, this is implemented trough a sub library.

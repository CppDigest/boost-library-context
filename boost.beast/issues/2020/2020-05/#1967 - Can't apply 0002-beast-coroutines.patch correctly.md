# #1967 - Can't apply 0002-beast-coroutines.patch correctly [Closed]

> Username: xavier2k6  
> Created at: 2020-05-30 11:14:10 UTC  
> Updated at: 2020-06-04 14:08:40 UTC  
> Closed at: 2020-06-04 14:08:40 UTC  
> Url: https://github.com/boostorg/beast/issues/1967  

I was successfully able to apply [0001-outcome-assert.patch](https://www.boost.org/patches/1_73_0/0001-outcome-assert.patch)  
  
But can't seem to fully apply below:  
  
How to correctly apply [0002-beast-coroutines.patch](https://www.boost.org/patches/1_73_0/0002-beast-coroutines.patch) to boost 1.73 using MSVC command line `patch` command?  
  
This is more of a `PEBKAC` issue rather than an issue with the patch, but I would really appreciate any help/guidance to have the patch applied fully.
...
> Username: madmongo1  
> Created at: 2020-06-01 07:45:16 UTC  
> Url: https://github.com/boostorg/beast/issues/1967#issuecomment-636672588  

Ho @xavier2k6 ,   
  
What output do you get when trying to apply the patch?
...
> Username: xavier2k6  
> Created at: 2020-06-03 13:38:12 UTC  
> Url: https://github.com/boostorg/beast/issues/1967#issuecomment-638202775  

this is how far I get:  
(the patch `0002-beast-coroutines.patch` is in `C:\Users\PC\Downloads\qBittorrent compilation files\boost_1_73_0\boost`)  
```  
**********************************************************************  
...
C:\Windows\System32>cd C:\Users\PC\Downloads\qBittorrent compilation files\boost_1_73_0  
  
C:\Users\PC\Downloads\qBittorrent compilation files\boost_1_73_0>cd boost  
  
C:\Users\PC\Downloads\qBittorrent compilation files\boost_1_73_0\boost>patch -p 0 < 0002-beast-coroutines.patch  
...
--------------------------  
File to patch: boost/beast/core/detail/impl/read.hpp  
boost/beast/core/detail/impl/read.hpp: No such file or directory  
Skip this patch? [y] n  
File to patch: beast/core/detail/impl/read.hpp  
patching file beast/core/detail/impl/read.hpp  
can't find file to patch at input line 16  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
--------------------------  
|/boost/beast/core/detail/is_invocable.hpp b/boost/beast/core/detail/is_invocable.hpp  
...
--------------------------  
File to patch: beast/core/detail/is_invocable.hpp  
patching file beast/core/detail/is_invocable.hpp  
...
--------------------------  
File to patch: beast/core/detail/read.hpp  
patching file beast/core/detail/read.hpp  
can't find file to patch at input line 67  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
--------------------------  
|l.hpp b/boost/beast/core/detect_ssl.hpp  
...
--------------------------  
File to patch: beast/core/detect_ssl.hpp  
patching file beast/core/detect_ssl.hpp  
...
--------------------------  
File to patch: beast/core/impl/basic_stream.hpp  
patching file beast/core/impl/basic_stream.hpp  
...
> Username: madmongo1  
> Created at: 2020-06-03 13:54:10 UTC  
> Url: https://github.com/boostorg/beast/issues/1967#issuecomment-638213485  

Are you one directory too deep? The file to be patched is `boost/beast/core/detail/impl/read.hpp` but you have already done `cd boost`. You'll need to be in a directory where `ls boost/beast/core/detail/impl/read.hpp` doesn't yield an error.  
...
> Username: xavier2k6  
> Created at: 2020-06-03 14:19:50 UTC  
> Url: https://github.com/boostorg/beast/issues/1967#issuecomment-638229742  

>Is that the case?  
  
Isn't the patch made up of multiple file patch locations though?  
  
(Hence, why I can only get so far.......no next file location given to apply patch...)  
...
C:\Users\PC\Downloads\qBittorrent compilation files\boost_1_73_0>patch -p 0 < 0002-beast-coroutines.patch  
can't find file to patch at input line 4  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
--------------------------  
...
--------------------------  
File to patch: boost/beast/core/detail/impl/read.hpp  
patching file boost/beast/core/detail/impl/read.hpp  
can't find file to patch at input line 16  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
--------------------------  
...
|+++ b/boost/beast/core/detail/is_invocable.hpp 2020-05-02 13:50:11.141761700 -0400  
--------------------------  
File to patch: boost/beast/core/detail/is_invocable.hpp  
patching file boost/beast/core/detail/is_invocable.hpp  
can't find file to patch at input line 55  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
--------------------------  
...
|+++ b/boost/beast/core/detail/read.hpp 2020-05-02 13:50:11.142761711 -0400  
--------------------------  
File to patch: boost/beast/core/detail/read.hpp  
patching file boost/beast/core/detail/read.hpp  
can't find file to patch at input line 67  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
--------------------------  
...
|+++ b/boost/beast/core/detect_ssl.hpp  2020-05-02 13:50:11.143761722 -0400  
--------------------------  
File to patch: boost/beast/core/detect_ssl.hpp  
patching file boost/beast/core/detect_ssl.hpp  
can't find file to patch at input line 95  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
--------------------------  
...
|+++ b/boost/beast/core/impl/basic_stream.hpp   2020-05-02 13:50:11.144761733 -0400  
--------------------------  
File to patch: boost/beast/core/impl/basic_stream.hpp  
patching file boost/beast/core/impl/basic_stream.hpp  
missing header for unified diff at line 112 of patch  
can't find file to patch at input line 112  
Perhaps you used the wrong -p or --strip option?  
The text leading up to this was:  
...
> Username: madmongo1  
> Created at: 2020-06-03 14:46:44 UTC  
> Url: https://github.com/boostorg/beast/issues/1967#issuecomment-638246737  

are the headers there? Are you working with a zip file you downloaded or a source tree you pulled from github?  
  
If the latter you'll need to bootstrap and then `.\b2 headers`
...
> Username: xavier2k6  
> Created at: 2020-06-03 15:01:19 UTC  
> Url: https://github.com/boostorg/beast/issues/1967#issuecomment-638255473  

>are the headers there?  
  
unsure  
  
>Are you working with a zip file you downloaded or a source tree you pulled from github?  
  
Downloaded (right click, save as) from -> [Boost C++ Library Patches](https://www.boost.org/patches/)  
  
If I open the `.patch` file with an editor below is what I see:  
...
> Username: madmongo1  
> Created at: 2020-06-04 14:08:40 UTC  
> Url: https://github.com/boostorg/beast/issues/1967#issuecomment-638873049  

# #407 [OpenBSD] Build Fix. [Closed]

> Username: ghost  
> Created at: 2024-09-30 03:39:52 UTC  
> Updated at: 2024-10-29 00:36:50 UTC  
> Closed at: 2024-10-27 09:56:04 UTC  
> Url: https://github.com/boostorg/process/pull/407  

It's building the boost process library now.  
  
Fixes: https://github.com/boostorg/process/issues/391  
  
The only tests that don't pass locally can be seen in the log below.  
  
These failing tests are just things not supported by OpenBSD.  
...
...found 5415 targets...  
...updating 24 targets...  
clang-linux.compile.c++ ../../../../bin.v2/libs/process/build/clang-linux-13/debug/x86_64/boost.process.fs-boost/visibility-global/ext/cwd.o  
...
ext.cpp(18): Leaving test case "test_exe"; testing time: 2950us  
...
ext.cpp(30): Leaving test case "test_child_exe"; testing time: 4788us  
...
ext.cpp(41): Leaving test case "cmd"; testing time: 1031us  
...
ext.cpp(121): Leaving test case "test_env"; testing time: 2282us  
...
ext.cpp(175): info: check itr != env.end() has passed  
ext.cpp(176): info: check kp.value() == (*itr).value() has passed  
ext.cpp(145): Leaving test case "test_env_exe"; testing time: 5008us  
ext.cpp(16): Leaving test suite "ext"; testing time: 25009us  
Leaving test module "process_v2_test"; testing time: 25393us  
...
> Created_at: 2024-10-27 09:56:04 UTC  
> Url: https://github.com/boostorg/process/pull/407#issuecomment-2439933414  

Merged as squash in c8499e0.

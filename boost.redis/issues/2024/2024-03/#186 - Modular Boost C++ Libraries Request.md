# #186 - Modular Boost C++ Libraries Request [Closed]

> Username: grafikrobot  
> Created at: 2024-03-09 19:33:18 UTC  
> Updated at: 2024-03-10 09:10:42 UTC  
> Closed at: 2024-03-10 09:10:41 UTC  
> Url: https://github.com/boostorg/redis/issues/186  
...
> Username: mzimbres  
> Created at: 2024-03-10 09:10:41 UTC  
> Url: https://github.com/boostorg/redis/issues/186#issuecomment-1987153022  

Hi, I will take 1.  
  
> Also please indicate any special instructions you want us to consider. Or other information you want us to be aware of.  
  
Boost.Redis integration test use an external server that was shut down and for which I have no replacement yet. This might result in some integrations tests in [this](https://github.com/boostorg/redis/blob/develop/test/test_conn_tls.cpp) file failing. If this happens to you just mark me in the PR and will check if you can just disable them for merging and I will catch up later. Thanks.
